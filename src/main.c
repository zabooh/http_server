...
static int cmd_heapstat(const struct shell *shell, size_t argc, char **argv)
{
...
int main(void)
{
	...
	SHELL_CMD_REGISTER(heapstat, NULL, "Show Heap Statistics", cmd_heapstat);
